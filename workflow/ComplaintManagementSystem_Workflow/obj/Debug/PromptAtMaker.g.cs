...
namespace ComplaintManagementSystem_Workflow {
    ...
    public partial class PromptAtMaker : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InArgument<string> _RequiredDocument;
...
partial void AfterInitializeComponent();
        ...
        public PromptAtMaker() {
            this.InitializeComponent();
        }
        
        public System.Activities.InArgument<string> RequiredDocument {
            get {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(PromptAtMaker).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(PromptAtMaker));
        ...
        private string FindResource() {
            string[] resources = typeof(PromptAtMaker).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".PromptAtMaker.g.xaml") || resource.Equals("PromptAtMaker.g.xaml"))) {
                    return resource;
                }
            }
